...
支持 ESP32 和 ESP32-C3 的电波钟信号发送器，具有 Web 配置界面、WiFi 网络配置和多时间多协议调度功能。
...
#### 时间计划
- **添加计划**：点击"添加计划/Add Schedule"添加新的时间段
- **设置时间范围**：输入框设置 开始时间 和 结束时间
- **选择电波**：从下拉菜单选择该时段使用的电波
- **删除**：点击"删除/Delete"删除计划
...
基于原始 nisejjy 项目进行增强
https://github.com/tarohs/nisejjy
